...
declare global {
  ...
  const MainLayout: typeof import('./app/layout/MainLayout')['MainLayout']
  const NavLink: typeof import('react-router-dom')['NavLink']
  const NavMain: typeof import('./components/nav-main')['NavMain']
  const NavProjects: typeof import('./components/nav-projects')['NavProjects']
  const NavSecondary: typeof import('./components/nav-secondary')['NavSecondary']
  const NavUser: typeof import('./components/nav-user')['NavUser']
  ...
  const Sidebar: typeof import('./app/layout/Sidebar')['Sidebar']
  ...
  const Topbar: typeof import('./app/layout/Topbar')['Topbar']
